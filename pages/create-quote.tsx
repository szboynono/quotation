  ...
  return (
    <>
      ...
      >
        ...
        />
         {quote.error && <p className="text-red-500 text-xs italic">Please enter the quote.</p>}
        ...
        />
        {name.error && <p className="text-red-500 text-xs italic">Please enter the name.</p>}
